...
{
	[SerializeField] DialogPanel leftPanel;
    [SerializeField] DialogPanel rightPanel;
	Canvas canvas;
	...
	IEnumerator Sequence (ConversationData data)
    {
		for (int i = 0; i < data.list.Count; ++i)
		{
			...
			DialogPanel currentPanel = (sd.anchor == TextAnchor.UpperLeft || sd.anchor == TextAnchor.MiddleLeft || sd.anchor == TextAnchor.LowerLeft) ? leftPanel : rightPanel;
	...
	void MovePanel (DialogPanel obj, string pos)
    {
